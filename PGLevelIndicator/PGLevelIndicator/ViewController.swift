...
class ViewController: UIViewController {
    ...
    private func getLevelIndicatorParameter() -> [ItemParameters] {
        ...
        let attStringO3 = NSMutableAttributedString(string: "O3", attributes: [.font: font!])

        attStringO3.setAttributes([.font: fontSuper!, .baselineOffset: -5],
                                  range: NSRange(location: 1, length: 1))

        let attStringpM10 = NSMutableAttributedString(string: "PM10", attributes: [.font: font!])

        attStringpM10.setAttributes([.font: fontSuper!, .baselineOffset: -5],
                                    range: NSRange(location: 2, length: 2))

        let attStringPM25 = NSMutableAttributedString(string: "PM2.5", attributes: [.font: font!])

        attStringPM25.setAttributes([.font: fontSuper!, .baselineOffset: -5],
                                    range: NSRange(location: 2, length: 3))

        let attStringSO2 = NSMutableAttributedString(string: "SO2", attributes: [.font: font!])

        attStringSO2.setAttributes([.font: fontSuper!, .baselineOffset: -5],
                                   range: NSRange(location: 2, length: 1))
